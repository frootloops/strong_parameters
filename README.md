...
## Code Status
- [![Build Status](https://travis-ci.org/rails/strong_parameters.png?branch=master)](https://travis-ci.org/rails/strong_parameters)
- [![Dependency Status](https://gemnasium.com/rails/strong_parameters.png)](https://gemnasium.com/rails/strong_parameters)

## License

Strong Parameters is released under the [MIT License](http://opensource.org/licenses/MIT).
